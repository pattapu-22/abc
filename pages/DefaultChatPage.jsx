...
//       {/* Main Section */}
//       <div className="w-full h-5/6  px-40 p-2 flex bg-black justify-between">
//         <div className=" w-full flex  flex-col">
//           {/* Display chat-like history */}
//           <div className="text-gray-300 p-4 border-2 h-full min-h-full overflow-y-auto" style={{ maxHeight: '400px' }}>
//             {!isSubmitted ? (
